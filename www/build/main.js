...
ListPage = ListPage_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-list',template:/*ion-inline-start:"/Users/yoyo/buildcloud/src/pages/list/list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-left></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-right>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/yoyo/buildcloud/src/pages/list/list.html"*/
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_multiline_multiline__ = __webpack_require__(262);
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_6__pages_multiline_multiline__["a" /* MultilinePage */]
        ],
        imports: [
...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen) {
        ...
        this.rootPage = __WEBPACK_IMPORTED_MODULE_6__pages_multiline_multiline__["a" /* MultilinePage */];
        this.initializeApp();
        // used for an example of ngFor and navigation
        this.pages = [
            { title: 'Home', component: __WEBPACK_IMPORTED_MODULE_4__pages_home_home__["a" /* HomePage */] },
            { title: 'List', component: __WEBPACK_IMPORTED_MODULE_5__pages_list_list__["a" /* ListPage */] },
            { title: 'Multiline', component: __WEBPACK_IMPORTED_MODULE_6__pages_multiline_multiline__["a" /* MultilinePage */] }
        ];
    }
